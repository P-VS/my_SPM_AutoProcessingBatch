function [ppparams,params,datpath] = my_spmbatch_1stlevel_FindData(sub,ses,run,task,datpath,params)

if params.onVSC, [datpath,params] = before_1stlevel_VSC(datpath,sub,ses,params); end
...
function [datpath,params] = before_1stlevel_VSC(datpath,sub,ses,params)
...
try
    ...
    if isfolder(fullfile(orig_subpath,params.preprocfmridir)), copyfile(fullfile(orig_subpath,params.preprocfmridir),fullfile(new_subpath,params.preprocfmridir)); end
